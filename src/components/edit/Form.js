...
import { useEditVideoMutation } from "../../fetures/api/apiSlice";
...
export default function Form({ video }) {
    const { id, title: initialTitle, author: initialAuthor, description: initialDescription, link: initialLink, thumbnail: initialThumbnail, duration: initialDuration, date: initialDate, views: initialViews } = video;

    const [editVideo, { data: editedVideo, isLoading, isError, isSuccess }] = useEditVideoMutation({ video })
