...
import { useDeleteVideoMutation } from "../../fetures/api/apiSlice";
        ...
        <div>
            ...
            <div className="pb-4 flex items-center space-between border-b gap-4">
                ...
                <div className="flex gap-6 w-full justify-end">
                    ...
                    <div className="flex gap-1" onClick={() => handleDelete(id)
                    }>
                        <div className="shrink-0">
                            <img
                                className="w-5 block"
            ...
            {!isLoading && isError && <Error message="There was an error"></Error>}
        </div>
    );
}
